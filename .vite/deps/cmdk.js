"use client";
import { Content, Overlay, Portal, Root } from "./chunk-QGLM555Z.js";
...
function G(_, C, h, P2, A, f, O) {
  ...
  for (var L2 = P2.charAt(f), c = h.indexOf(L2, A), S = 0, E, N2, R, M; c >= 0; )
    ((E = G(_, C, h, P2, c + 1, f + 1, O)),
      ...
      ((E < p && h.charAt(c - 1) === P2.charAt(f + 1)) ||
        (P2.charAt(f + 1) === P2.charAt(f) && h.charAt(c - 1) !== P2.charAt(f))) &&
        ((N2 = G(_, C, h, P2, c + 1, f + 2, O)), N2 * p > E && (E = N2 * p)),
      E > S && (S = E),
      (c = h.indexOf(L2, c + 1)));
  return ((O[T2] = S), S);
}
...
var me = t.forwardRef((r, o) => {
  let n = L(() => {
    ...
    p2 = pe(r),
    {
      ...
      shouldFilter: S,
      loop: A,
      disablePointerSelection: ge = false,
      vimBindings: j = true,
      ...O
    } = r,
    $2 = useId(),
          ...
          if (!Object.is(n.current[e], a)) {
            if (((n.current[e] = a), e === "search")) (J2(), z(), v(1, W2));
              ...
              if (
                ...
                s || v(5, ne),
                ((l = p2.current) == null ? void 0 : l.value) !== void 0)
              ) {
                let h = a != null ? a : "";
        ...
        item: (e, a) => (
          ...
          a &&
            (c.current.has(a)
              ...
              : c.current.set(a, /* @__PURE__ */ new Set([e]))),
          v(3, () => {
  ...
  function z() {
    ...
    (V()
      ...
      .forEach((i) => {
        let l = i.closest(Y2);
        l
          ? l.appendChild(i.parentElement === l ? i : i.closest(`${Y2} > *`))
          : s.appendChild(i.parentElement === s ? i : i.closest(`${Y2} > *`));
      }),
      a
        .sort((i, l) => l[1] - i[1])
        .forEach((i) => {
  ...
  function J2() {
    ...
    for (let g of u2.current) {
      let y = (s = (a = d.current.get(g)) == null ? void 0 : a.value) != null ? s : "",
        h = (l = (i = d.current.get(g)) == null ? void 0 : i.keywords) != null ? l : [],
        F = te(y, h);
  ...
  return t.createElement(
    ...
    t.createElement(
      "label",
      { "cmdk-label": "", htmlFor: U2.inputId, id: U2.labelId, style: Te },
      b,
    ),
    B2(r, (e) =>
      t.createElement(de.Provider, { value: E }, t.createElement(ue.Provider, { value: U2 }, e)),
    ),
  );
});
var he = t.forwardRef((r, o) => {
  ...
  let b = ve(n, u2, [r.value, r.children, u2], r.keywords),
    m2 = ee(),
    R = P((v) => v.value && v.value === b.current),
    x = P((v) =>
      p2 || d.filter() === false ? true : v.search ? v.filtered.items.get(n) > 0 : true,
    );
  t.useEffect(() => {
    let v = u2.current;
...
var Ee = t.forwardRef((r, o) => {
  let { heading: n, children: u2, forceMount: c, ...d } = r,
    ...
    m2 = useId(),
    R = K2(),
    x = P((S) => (c || R.filter() === false ? true : S.search ? S.filtered.groups.has(f) : true));
  (k2(() => R.group(f), []), ve(f, p2, [r.value, r.heading, b]));
  let C = t.useMemo(() => ({ id: f, forceMount: c }), [c]);
  return t.createElement(
    Primitive.div,
    {
      ref: composeRefs(p2, o),
      ...d,
      "cmdk-group": "",
      role: "presentation",
    ...
    n &&
      t.createElement("div", { ref: b, "cmdk-group-heading": "", "aria-hidden": true, id: m2 }, n),
    B2(r, (S) =>
      t.createElement(
        "div",
        { "cmdk-group-items": "", role: "group", "aria-labelledby": n ? m2 : void 0 },
...
var Se = t.forwardRef((r, o) => {
  let { onValueChange: n, ...u2 } = r,
    ...
    d = ee(),
    f = P((m2) => m2.search),
    p2 = P((m2) => m2.selectedItemId),
    b = K2();
  return (
    t.useEffect(() => {
      r.value != null && d.setState("search", r.value);
    }, [r.value]),
    t.createElement(Primitive.input, {
      ref: o,
      ...u2,
      "cmdk-input": "",
      autoComplete: "off",
...
var Ce = t.forwardRef((r, o) => {
  ...
  return (
    ...
    t.createElement(
      ...
      B2(r, (m2) =>
        t.createElement("div", { ref: composeRefs(f, b.listInnerRef), "cmdk-list-sizer": "" }, m2),
      ),
    )
  );
});
var xe = t.forwardRef((r, o) => {
  ...
  return t.createElement(
    Root,
    { open: n, onOpenChange: u2 },
    t.createElement(
      Portal,
      { container: f },
      t.createElement(Overlay, { "cmdk-overlay": "", className: c }),
      t.createElement(
        Content,
        { "aria-label": r.label, "cmdk-dialog": "", className: d },
        t.createElement(me, { ref: o, ...p2 }),
      ),
    ),
  );
});
var Ie = t.forwardRef((r, o) =>
  P((u2) => u2.filtered.count === 0)
    ? t.createElement(Primitive.div, { ref: o, ...r, "cmdk-empty": "", role: "presentation" })
    : null,
);
var Pe = t.forwardRef((r, o) => {
  ...
  return t.createElement(
    ...
    B2(r, (f) => t.createElement("div", { "aria-hidden": true }, f)),
  );
});
...
function B2({ asChild: r, children: o }, n) {
  return r && t.isValidElement(o)
    ? t.cloneElement(Me(o), { ref: o.ref }, n(o.props.children))
    : n(o);
}
var Te = {
  position: "absolute",
