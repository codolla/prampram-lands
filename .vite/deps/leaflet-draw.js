...
!(function (t, e, i) {
  ...
  ((L.drawVersion = "1.0.4"),
    ...
    (L.Draw.Feature = L.Handler.extend({
      initialize: function (t2, e2) {
        ((this._map = t2),
          ...
          (this._overlayPane = t2._panes.overlayPane),
          (this._popupPane = t2._panes.popupPane),
          e2 &&
            e2.shapeOptions &&
            (e2.shapeOptions = L.Util.extend({}, this.options.shapeOptions, e2.shapeOptions)),
          L.setOptions(this, e2));
        var i2 = L.version.split(".");
        1 === parseInt(i2[0], 10) && parseInt(i2[1], 10) >= 2
    ...
    (L.Draw.Polyline = L.Draw.Feature.extend({
      ...
      initialize: function (t2, e2) {
        (L.Browser.touch && (this.options.icon = this.options.touchIcon),
          ...
          e2 &&
            e2.drawError &&
            (e2.drawError = L.Util.extend({}, this.options.drawError, e2.drawError)),
          (this.type = L.Draw.Polyline.TYPE),
          L.Draw.Feature.prototype.initialize.call(this, t2, e2));
      },
      addHooks: function () {
      ...
      deleteLastVertex: function () {
        if (!(this._markers.length <= 1)) {
          var t2 = this._markers.pop(),
            e2 = this._poly,
            i2 = e2.getLatLngs(),
            o2 = i2.splice(-1, 1)[0];
          (this._poly.setLatLngs(i2),
            this._markerGroup.removeLayer(t2),
            e2.getLatLngs().length < 2 && this._map.removeLayer(e2),
            this._vertexChanged(o2, false));
        }
      },
      ...
      _finishShape: function () {
        var t2 = this._poly._defaultShape ? this._poly._defaultShape() : this._poly.getLatLngs(),
          e2 = this._poly.newLatLngIntersects(t2[t2.length - 1]);
      ...
      _onMouseMove: function (t2) {
        var e2 = this._map.mouseEventToLayerPoint(t2.originalEvent),
          i2 = this._map.layerPointToLatLng(e2);
        ((this._currentLatLng = i2),
          this._updateTooltip(i2),
          this._updateGuide(e2),
          this._mouseMarker.setLatLng(i2),
          L.DomEvent.preventDefault(t2.originalEvent));
      },
      _vertexChanged: function (t2, e2) {
        (this._map.fire(L.Draw.Event.DRAWVERTEX, { layers: this._markerGroup }),
          this._updateFinishHandler(),
          this._updateRunningMeasure(t2, e2),
          this._clearGuides(),
          this._updateTooltip());
      },
      ...
      _endPoint: function (e2, i2, o2) {
        if (this._mouseDownOrigin) {
          var a = L.point(e2, i2).distanceTo(this._mouseDownOrigin),
            n = this._calculateFinishDistance(o2.latlng);
          (this.options.maxPoints > 1 && this.options.maxPoints == this._markers.length + 1
            ? (this.addVertex(o2.latlng), this._finishShape())
            : n < 10 && L.Browser.touch
              ? this._finishShape()
              : Math.abs(a) < 9 * (t.devicePixelRatio || 1) && this.addVertex(o2.latlng),
      ...
      _onTouch: function (t2) {
        ...
        (!o2.touches ||
          ...
          ((e2 = o2.touches[0].clientX),
          (i2 = o2.touches[0].clientY),
          this._disableNewMarkers(),
          (this._touchHandled = true),
          this._startPoint.call(this, e2, i2),
          this._endPoint.call(this, e2, i2, t2),
      ...
      _calculateFinishDistance: function (t2) {
        ...
        if (this._markers.length > 0) {
          ...
          var o2 = this._map.latLngToContainerPoint(i2.getLatLng()),
            a = new L.Marker(t2, {
      ...
      _updateFinishHandler: function () {
        ...
        (t2 > 1 && this._markers[t2 - 1].on("click", this._finishShape, this),
          t2 > 2 && this._markers[t2 - 2].off("click", this._finishShape, this));
      },
      ...
      _updateGuide: function (t2) {
        ...
        e2 > 0 &&
          ((t2 = t2 || this._map.latLngToLayerPoint(this._currentLatLng)),
          this._clearGuides(),
          this._drawGuide(this._map.latLngToLayerPoint(this._markers[e2 - 1].getLatLng()), t2));
      },
      _updateTooltip: function (t2) {
        var e2 = this._getTooltipText();
        (t2 && this._tooltip.updatePosition(t2),
          this._errorShown || this._tooltip.updateContent(e2));
      },
      _drawGuide: function (t2, e2) {
        var i2,
          o2,
          a,
          n = Math.floor(Math.sqrt(Math.pow(e2.x - t2.x, 2) + Math.pow(e2.y - t2.y, 2))),
      ...
      _getTooltipText: function () {
        var t2,
          e2,
          i2 = this.options.showLength;
        return (
          0 === this._markers.length
            ? (t2 = { text: L.drawLocal.draw.handlers.polyline.tooltip.start })
            : ((e2 = i2 ? this._getMeasurementString() : ""),
              (t2 =
                1 === this._markers.length
                  ? { text: L.drawLocal.draw.handlers.polyline.tooltip.cont, subtext: e2 }
                  : { text: L.drawLocal.draw.handlers.polyline.tooltip.end, subtext: e2 })),
          t2
        );
      },
      _updateRunningMeasure: function (t2, e2) {
        ...
        1 === this._markers.length
          ...
          : ((i2 = a - (e2 ? 2 : 1)),
            (o2 = L.GeometryUtil.isVersion07x()
              ? t2.distanceTo(this._markers[i2].getLatLng()) * (this.options.factor || 1)
              : this._map.distance(t2, this._markers[i2].getLatLng()) * (this.options.factor || 1)),
            (this._measurementRunningTotal += o2 * (e2 ? 1 : -1)));
      },
      _getMeasurementString: function () {
        var t2,
          e2 = this._currentLatLng,
          i2 = this._markers[this._markers.length - 1].getLatLng();
        return (
          (t2 = L.GeometryUtil.isVersion07x()
            ? i2 && e2 && e2.distanceTo
              ? this._measurementRunningTotal + e2.distanceTo(i2) * (this.options.factor || 1)
              : this._measurementRunningTotal || 0
            : i2 && e2
              ? this._measurementRunningTotal +
                this._map.distance(e2, i2) * (this.options.factor || 1)
              : this._measurementRunningTotal || 0),
    ...
    (L.Draw.Polygon = L.Draw.Polyline.extend({
      ...
      initialize: function (t2, e2) {
        (L.Draw.Polyline.prototype.initialize.call(this, t2, e2),
          (this.type = L.Draw.Polygon.TYPE));
      },
      _updateFinishHandler: function () {
        var t2 = this._markers.length;
        (1 === t2 && this._markers[0].on("click", this._finishShape, this),
          t2 > 2 &&
            (this._markers[t2 - 1].on("dblclick", this._finishShape, this),
            t2 > 3 && this._markers[t2 - 2].off("dblclick", this._finishShape, this)));
      },
      _getTooltipText: function () {
        var t2, e2;
        return (
          0 === this._markers.length
            ? (t2 = L.drawLocal.draw.handlers.polygon.tooltip.start)
            : this._markers.length < 3
              ? ((t2 = L.drawLocal.draw.handlers.polygon.tooltip.cont),
                (e2 = this._getMeasurementString()))
              : ((t2 = L.drawLocal.draw.handlers.polygon.tooltip.end),
                (e2 = this._getMeasurementString())),
          { text: t2, subtext: e2 }
        );
      },
      _getMeasurementString: function () {
        var t2 = this._area,
          e2 = "";
        return t2 || this.options.showLength
          ? (this.options.showLength &&
              (e2 = L.Draw.Polyline.prototype._getMeasurementString.call(this)),
            t2 &&
              (e2 +=
                "<br>" +
                L.GeometryUtil.readableArea(t2, this.options.metric, this.options.precision)),
            e2)
          : null;
      },
      _shapeIsValid: function () {
      ...
      _vertexChanged: function (t2, e2) {
        ...
        (!this.options.allowIntersection &&
          ...
          ((i2 = this._poly.getLatLngs()), (this._area = L.GeometryUtil.geodesicArea(i2))),
          L.Draw.Polyline.prototype._vertexChanged.call(this, t2, e2));
      },
      _cleanUpShape: function () {
        var t2 = this._markers.length;
        t2 > 0 &&
          (this._markers[0].off("click", this._finishShape, this),
          t2 > 2 && this._markers[t2 - 1].off("dblclick", this._finishShape, this));
      },
    })),
    (L.SimpleShape = {}),
    (L.Draw.SimpleShape = L.Draw.Feature.extend({
      ...
      addHooks: function () {
        (L.Draw.Feature.prototype.addHooks.call(this),
          this._map &&
            ...
            e.addEventListener("touchstart", L.DomEvent.preventDefault, { passive: false })));
      },
      removeHooks: function () {
        (L.Draw.Feature.prototype.removeHooks.call(this),
          this._map &&
      ...
      _onMouseDown: function (t2) {
        ((this._isDrawing = true),
          (this._startLatLng = t2.latlng),
          L.DomEvent.on(e, "mouseup", this._onMouseUp, this)
            .on(e, "touchend", this._onMouseUp, this)
            .preventDefault(t2.originalEvent));
      },
      _onMouseMove: function (t2) {
        var e2 = t2.latlng;
        (this._tooltip.updatePosition(e2),
          this._isDrawing &&
            (this._tooltip.updateContent(this._getTooltipText()), this._drawShape(e2)));
      },
      _onMouseUp: function () {
    ...
    (L.Draw.Rectangle = L.Draw.SimpleShape.extend({
      ...
      initialize: function (t2, e2) {
        ((this.type = L.Draw.Rectangle.TYPE),
          ...
          L.Draw.SimpleShape.prototype.initialize.call(this, t2, e2));
      },
      disable: function () {
        this._enabled &&
      ...
      _onMouseUp: function (t2) {
        ...
        (this._isCurrentlyTwoClickDrawing && !o(t2.target, "leaflet-pane")) ||
          L.Draw.SimpleShape.prototype._onMouseUp.call(this);
      },
      _drawShape: function (t2) {
        this._shape
          ? this._shape.setBounds(new L.LatLngBounds(this._startLatLng, t2))
          : ((this._shape = new L.Rectangle(
              new L.LatLngBounds(this._startLatLng, t2),
      ...
      _getTooltipText: function () {
        var t2,
          e2,
          i2,
          o2 = L.Draw.SimpleShape.prototype._getTooltipText.call(this),
          a = this._shape,
          n = this.options.showArea;
        return (
          a &&
            ((t2 = this._shape._defaultShape
              ? this._shape._defaultShape()
              : this._shape.getLatLngs()),
            (e2 = L.GeometryUtil.geodesicArea(t2)),
            (i2 = n ? L.GeometryUtil.readableArea(e2, this.options.metric) : "")),
          { text: o2.text, subtext: i2 }
        );
      },
    })),
    (L.Draw.Marker = L.Draw.Feature.extend({
      statics: { TYPE: "marker" },
      options: { icon: new L.Icon.Default(), repeatMode: false, zIndexOffset: 2e3 },
      initialize: function (t2, e2) {
      ...
      _onMouseMove: function (t2) {
        var e2 = t2.latlng;
        (this._tooltip.updatePosition(e2),
          this._mouseMarker.setLatLng(e2),
          this._marker
            ? ((e2 = this._mouseMarker.getLatLng()), this._marker.setLatLng(e2))
            : ((this._marker = this._createMarker(e2)),
    ...
    (L.Draw.Circle = L.Draw.SimpleShape.extend({
      ...
      _drawShape: function (t2) {
        ...
        this._shape
          ? this._shape.setRadius(e2)
          : ((this._shape = new L.Circle(this._startLatLng, e2, this.options.shapeOptions)),
            this._map.addLayer(this._shape));
      },
      _fireCreatedEvent: function () {
        var t2 = new L.Circle(
        ...
        if ((this._tooltip.updatePosition(i2), this._isDrawing)) {
          ...
          (o2 &&
            (n =
              ...
              ": " +
              L.GeometryUtil.readableDistance(e2, a, this.options.feet, this.options.nautic)),
    ...
    (L.Edit.Marker = L.Handler.extend({
      ...
      addHooks: function () {
        var t2 = this._marker;
        (t2.dragging.enable(),
          t2.on("dragend", this._onDragEnd, t2),
          this._toggleMarkerHighlight());
      },
      removeHooks: function () {
        var t2 = this._marker;
        (t2.dragging.disable(),
          t2.off("dragend", this._onDragEnd, t2),
          this._toggleMarkerHighlight());
      },
      ...
      _toggleMarkerHighlight: function () {
        ...
        t2 &&
          ...
          L.DomUtil.hasClass(t2, "leaflet-edit-marker-selected")
            ? (L.DomUtil.removeClass(t2, "leaflet-edit-marker-selected"),
              this._offsetMarker(t2, -4))
            : (L.DomUtil.addClass(t2, "leaflet-edit-marker-selected"), this._offsetMarker(t2, 4)),
          (t2.style.display = ""));
      },
      _offsetMarker: function (t2, e2) {
        var i2 = parseInt(t2.style.marginTop, 10) - e2,
          o2 = parseInt(t2.style.marginLeft, 10) - e2;
    ...
    (L.Edit.Poly = L.Handler.extend({
      initialize: function (t2) {
        ((this.latlngs = [t2._latlngs]),
          t2._holes && (this.latlngs = this.latlngs.concat(t2._holes)),
          (this._poly = t2),
      ...
      _initHandlers: function () {
        ...
        for (var t2 = 0; t2 < this.latlngs.length; t2++)
          this._verticesHandlers.push(
            new L.Edit.PolyVerticesEdit(this._poly, this.latlngs[t2], this._poly.options.poly),
          );
      },
      _updateLatLngs: function (t2) {
        ((this.latlngs = [t2.layer._latlngs]),
          t2.layer._holes && (this.latlngs = this.latlngs.concat(t2.layer._holes)));
      },
    })),
    (L.Edit.PolyVerticesEdit = L.Handler.extend({
      ...
      initialize: function (t2, e2, i2) {
        (L.Browser.touch && (this.options.icon = this.options.touchIcon),
          ...
          i2 &&
            i2.drawError &&
            (i2.drawError = L.Util.extend({}, this.options.drawError, i2.drawError)),
          (this._latlngs = e2),
          L.setOptions(this, i2));
      },
      _defaultShape: function () {
        return L.Polyline._flat
      ...
      addHooks: function () {
        var t2 = this._poly,
          e2 = t2._path;
        (t2 instanceof L.Polygon ||
          ((t2.options.fill = false), t2.options.editing && (t2.options.editing.fill = false)),
          e2 &&
            t2.options.editing &&
            t2.options.editing.className &&
            (t2.options.original.className &&
              t2.options.original.className.split(" ").forEach(function (t3) {
                L.DomUtil.removeClass(e2, t3);
              }),
            t2.options.editing.className.split(" ").forEach(function (t3) {
              L.DomUtil.addClass(e2, t3);
            })),
          t2.setStyle(t2.options.editing),
          this._poly._map &&
      ...
      removeHooks: function () {
        ...
        (e2 &&
          ...
          t2.setStyle(t2.options.original),
          t2._map &&
            (t2._map.removeLayer(this._markerGroup),
            delete this._markerGroup,
            delete this._markers));
      },
      updateMarkers: function () {
      ...
      _initMarkers: function () {
        ...
        for (t2 = 0, i2 = a.length; t2 < i2; t2++)
          ((o2 = this._createMarker(a[t2], t2)),
            o2.on("click", this._onMarkerClick, this),
            o2.on("contextmenu", this._onContextMenu, this),
            this._markers.push(o2));
        var n, s;
        for (t2 = 0, e2 = i2 - 1; t2 < i2; e2 = t2++)
          (0 !== t2 || (L.Polygon && this._poly instanceof L.Polygon)) &&
            ((n = this._markers[e2]),
            (s = this._markers[t2]),
      ...
      _spliceLatLngs: function () {
        var t2 = this._defaultShape(),
          e2 = [].splice.apply(t2, arguments);
        return (this._poly._convertLatLngs(t2, true), this._poly.redraw(), e2);
      },
      _removeMarker: function (t2) {
        var e2 = t2._index;
        (this._markerGroup.removeLayer(t2),
          this._markers.splice(e2, 1),
          this._spliceLatLngs(e2, 1),
          this._updateIndexes(e2, -1),
          t2
      ...
      _onMarkerDrag: function (t2) {
        var e2 = t2.target,
          i2 = this._poly,
          o2 = L.LatLngUtil.cloneLatLng(e2._origLatLng);
        if ((L.extend(e2._origLatLng, e2._latlng), i2.options.poly)) {
          ...
          if (!i2.options.poly.allowIntersection && i2.intersects()) {
            ...
            (i2.setStyle({ color: this.options.drawError.color }),
        ...
        (e2._middleLeft && e2._middleLeft.setLatLng(this._getMiddleLatLng(e2._prev, e2)),
          e2._middleRight && e2._middleRight.setLatLng(this._getMiddleLatLng(e2, e2._next)),
      ...
      _onMarkerClick: function (t2) {
        var e2 = L.Polygon && this._poly instanceof L.Polygon ? 4 : 3,
          i2 = t2.target;
        this._defaultShape().length < e2 ||
          (this._removeMarker(i2),
          this._updatePrevNext(i2._prev, i2._next),
          i2._middleLeft && this._markerGroup.removeLayer(i2._middleLeft),
          i2._middleRight && this._markerGroup.removeLayer(i2._middleRight),
          i2._prev && i2._next
            ? this._createMiddleMarker(i2._prev, i2._next)
            : i2._prev
              ? i2._next || (i2._prev._middleRight = null)
              : (i2._next._middleLeft = null),
          this._fireEdit());
      },
      ...
      _onTouchMove: function (t2) {
        var e2 = this._map.mouseEventToLayerPoint(t2.originalEvent.touches[0]),
          i2 = this._map.layerPointToLatLng(e2),
          o2 = t2.target;
        (L.extend(o2._origLatLng, i2),
          o2._middleLeft && o2._middleLeft.setLatLng(this._getMiddleLatLng(o2._prev, o2)),
          o2._middleRight && o2._middleRight.setLatLng(this._getMiddleLatLng(o2, o2._next)),
          this._poly.redraw(),
          this.updateMarkers());
      },
      ...
      _createMiddleMarker: function (t2, e2) {
        var i2,
          o2,
          a,
          n = this._getMiddleLatLng(t2, e2),
          s = this._createMarker(n);
        (s.setOpacity(0.6),
          (t2._middleRight = e2._middleLeft = s),
          (o2 = function () {
            s.off("touchmove", o2, this);
            var a2 = e2._index;
            ((s._index = a2),
              s.off("click", i2, this).on("click", this._onMarkerClick, this),
              (n.lat = s.getLatLng().lat),
              (n.lng = s.getLatLng().lng),
              this._spliceLatLngs(a2, 0, n),
              this._markers.splice(a2, 0, s),
              s.setOpacity(1),
              this._updateIndexes(a2, 1),
              e2._index++,
              this._updatePrevNext(t2, s),
              this._updatePrevNext(s, e2),
              this._poly.fire("editstart"));
          }),
          (a = function () {
            (s.off("dragstart", o2, this),
              s.off("dragend", a, this),
              s.off("touchmove", o2, this),
              this._createMiddleMarker(t2, s),
              this._createMiddleMarker(s, e2));
          }),
          (i2 = function () {
          ...
          s
            .on("click", i2, this)
            .on("dragstart", o2, this)
            .on("dragend", a, this)
            .on("touchmove", o2, this),
      ...
      _getMiddleLatLng: function (t2, e2) {
        var i2 = this._poly._map,
          o2 = i2.project(t2.getLatLng()),
          a = i2.project(e2.getLatLng());
    ...
    (L.Edit.SimpleShape = L.Handler.extend({
      ...
      _bindMarker: function (t2) {
        t2.on("dragstart", this._onMarkerDragStart, this)
          .on("drag", this._onMarkerDrag, this)
      ...
      _unbindMarker: function (t2) {
        t2.off("dragstart", this._onMarkerDragStart, this)
          .off("drag", this._onMarkerDrag, this)
      ...
      _onMarkerDrag: function (t2) {
        var e2 = t2.target,
          i2 = e2.getLatLng();
        (e2 === this._moveMarker ? this._move(i2) : this._resize(i2),
          this._shape.redraw(),
      ...
      _onTouchStart: function (t2) {
        if (
          ...
          var e2 = this._getCorners(),
            i2 = t2.target,
            o2 = i2._cornerIndex;
          (i2.setOpacity(0),
            (this._oppositeCorner = e2[(o2 + 2) % 4]),
            this._toggleCornerMarkers(0, o2));
        }
      ...
      _onTouchMove: function (t2) {
        var e2 = this._map.mouseEventToLayerPoint(t2.originalEvent.touches[0]),
          i2 = this._map.layerPointToLatLng(e2);
        return (
          t2.target === this._moveMarker ? this._move(i2) : this._resize(i2),
          this._shape.redraw(),
          false
        );
      },
    ...
    (L.Edit.Rectangle = L.Edit.SimpleShape.extend({
      ...
      _createResizeMarker: function () {
        ...
        for (var e2 = 0, i2 = t2.length; e2 < i2; e2++)
          (this._resizeMarkers.push(this._createMarker(t2[e2], this.options.resizeIcon)),
            (this._resizeMarkers[e2]._cornerIndex = e2));
      },
      _onMarkerDragStart: function (t2) {
        L.Edit.SimpleShape.prototype._onMarkerDragStart.call(this, t2);
        var e2 = this._getCorners(),
      ...
      _onMarkerDragEnd: function (t2) {
        var e2,
          ...
          o2 = t2.target;
        (o2 === this._moveMarker &&
          ((e2 = this._shape.getBounds()), (i2 = e2.getCenter()), o2.setLatLng(i2)),
          this._toggleCornerMarkers(1),
          this._repositionCornerMarkers(),
          L.Edit.SimpleShape.prototype._onMarkerDragEnd.call(this, t2));
      },
      _move: function (t2) {
        for (
          var e2,
            i2 = this._shape._defaultShape ? this._shape._defaultShape() : this._shape.getLatLngs(),
            o2 = this._shape.getBounds(),
            a = o2.getCenter(),
            n = [],
            s = 0,
            r = i2.length;
      ...
      _resize: function (t2) {
        var e2;
        (this._shape.setBounds(L.latLngBounds(t2, this._oppositeCorner)),
          (e2 = this._shape.getBounds()),
          this._moveMarker.setLatLng(e2.getCenter()),
    ...
    (L.Edit.Circle = L.Edit.CircleMarker.extend({
      ...
      _resize: function (t2) {
        ...
        (L.GeometryUtil.isVersion07x()
          ? (radius = e2.distanceTo(t2))
          : (radius = this._map.distance(e2, t2)),
    ...
    (L.Map.TouchExtend = L.Handler.extend({
      ...
      _touchEvent: function (t2, e2) {
        ...
        var o2 = this._map.mouseEventToContainerPoint(i2),
          a = this._map.mouseEventToLayerPoint(i2),
      ...
      _filterClick: function (t2) {
        var e2 = t2.timeStamp || t2.originalEvent.timeStamp,
          i2 = L.DomEvent._lastClick && e2 - L.DomEvent._lastClick;
        return (i2 && i2 > 100 && i2 < 500) || (t2.target._simulatedClick && !t2._simulated)
          ? (L.DomEvent.stop(t2), false)
          : ((L.DomEvent._lastClick = e2), true);
      },
      _onTouchStart: function (t2) {
    ...
    (L.Marker.Touch = L.Marker.extend({
      ...
      _initInteractionLegacy: function () {
        if (this.options.clickable) {
          ...
          (this._detectIE
            ? e2.concat(["MSPointerDown", "MSPointerUp", "MSPointerMove", "MSPointerCancel"])
            : e2.concat(["touchcancel"]),
            L.DomUtil.addClass(t2, "leaflet-clickable"),
            L.DomEvent.on(t2, "click", this._onMouseClick, this),
            L.DomEvent.on(t2, "keypress", this._onKeyPress, this));
    ...
    (L.LatLngUtil = {
      cloneLatLngs: function (t2) {
        for (var e2 = [], i2 = 0, o2 = t2.length; i2 < o2; i2++)
          Array.isArray(t2[i2])
            ? e2.push(L.LatLngUtil.cloneLatLngs(t2[i2]))
            : e2.push(this.cloneLatLng(t2[i2]));
        return e2;
      },
    ...
    (function () {
      ...
      L.GeometryUtil = L.extend(L.GeometryUtil || {}, {
        geodesicArea: function (t3) {
          ...
          if (o2 > 2) {
            for (var s = 0; s < o2; s++)
              ((e2 = t3[s]),
                (i2 = t3[(s + 1) % o2]),
                (a += (i2.lng - e2.lng) * n * (2 + Math.sin(e2.lat * n) + Math.sin(i2.lat * n))));
            a = (6378137 * a * 6378137) / 2;
          }
          return Math.abs(a);
        },
        formattedNumber: function (t3, e2) {
          var i2 = parseFloat(t3).toFixed(e2),
            o2 = L.drawLocal.format && L.drawLocal.format.numeric,
            a = o2 && o2.delimiters,
            n = a && a.thousands,
            s = a && a.decimal;
          if (n || s) {
            var r = i2.split(".");
            ((i2 = n ? r[0].replace(/(\d)(?=(\d{3})+(?!\d))/g, "$1" + n) : r[0]),
              (s = s || "."),
              r.length > 1 && (i2 = i2 + s + r[1]));
          }
          return i2;
        },
        readableArea: function (e2, i2, o2) {
          var a,
            n,
            o2 = L.Util.extend({}, t2, o2);
          return (
            i2
              ? ((n = ["ha", "m"]),
                (type = typeof i2),
                "string" === type ? (n = [i2]) : "boolean" !== type && (n = i2),
                (a =
                  e2 >= 1e6 && -1 !== n.indexOf("km")
                    ? L.GeometryUtil.formattedNumber(1e-6 * e2, o2.km) + " km²"
                    : e2 >= 1e4 && -1 !== n.indexOf("ha")
                      ? L.GeometryUtil.formattedNumber(1e-4 * e2, o2.ha) + " ha"
                      : L.GeometryUtil.formattedNumber(e2, o2.m) + " m²"))
              : ((e2 /= 0.836127),
                (a =
                  e2 >= 3097600
                    ? L.GeometryUtil.formattedNumber(e2 / 3097600, o2.mi) + " mi²"
                    : e2 >= 4840
                      ? L.GeometryUtil.formattedNumber(e2 / 4840, o2.ac) + " acres"
                      : L.GeometryUtil.formattedNumber(e2, o2.yd) + " yd²")),
            a
          );
        },
        readableDistance: function (e2, i2, o2, a, n) {
          var s,
            n = L.Util.extend({}, t2, n);
          switch (
            i2
              ? "string" == typeof i2
                ? i2
            ...
            case "metric":
              s =
                e2 > 1e3
                  ? L.GeometryUtil.formattedNumber(e2 / 1e3, n.km) + " km"
                  : L.GeometryUtil.formattedNumber(e2, n.m) + " m";
              break;
            case "feet":
            ...
            default:
              ((e2 *= 1.09361),
                (s =
                  e2 > 1760
                    ? L.GeometryUtil.formattedNumber(e2 / 1760, n.mi) + " miles"
                    : L.GeometryUtil.formattedNumber(e2, n.yd) + " yd"));
          }
          return s;
        },
    ...
    L.Util.extend(L.LineUtil, {
      segmentsIntersect: function (t2, e2, i2, o2) {
        return (
          this._checkCounterclockwise(t2, i2, o2) !== this._checkCounterclockwise(e2, i2, o2) &&
          this._checkCounterclockwise(t2, e2, i2) !== this._checkCounterclockwise(t2, e2, o2)
        );
      },
    ...
    L.Polyline.include({
      ...
      newPointIntersects: function (t2, e2) {
        var i2 = this._getProjectedPoints(),
          o2 = i2 ? i2.length : 0,
          a = i2 ? i2[o2 - 1] : null,
          n = o2 - 2;
        return (
          !this._tooFewPointsForIntersection(1) &&
          this._lineSegmentsIntersectsRange(a, t2, n, e2 ? 1 : 0)
        );
      },
      _tooFewPointsForIntersection: function (t2) {
        var e2 = this._getProjectedPoints(),
          i2 = e2 ? e2.length : 0;
      ...
      _lineSegmentsIntersectsRange: function (t2, e2, i2, o2) {
        ...
        o2 = o2 || 0;
        for (var r = i2; r > o2; r--)
          if (((a = s[r - 1]), (n = s[r]), L.LineUtil.segmentsIntersect(t2, e2, a, n))) return true;
        return false;
      },
      ...
      intersects: function () {
        ...
        return (
          ...
          (!!L.Polyline.prototype.intersects.call(this) ||
            ...
            (i2 = a[t2 - 1]),
            (o2 = t2 - 2),
            this._lineSegmentsIntersectsRange(i2, e2, o2, 1)))
        );
      },
    }),
    (L.Control.Draw = L.Control.extend({
      options: { position: "topleft", draw: {}, edit: false },
      initialize: function (t2) {
        if (L.version < "0.7")
          throw new Error(
        ...
        ((this._toolbars = {}),
          L.DrawToolbar &&
            this.options.draw &&
            ((e2 = new L.DrawToolbar(this.options.draw)),
            (this._toolbars[L.DrawToolbar.TYPE] = e2),
            this._toolbars[L.DrawToolbar.TYPE].on("enable", this._toolbarEnabled, this)),
          L.EditToolbar &&
            this.options.edit &&
            ((e2 = new L.EditToolbar(this.options.edit)),
            (this._toolbars[L.EditToolbar.TYPE] = e2),
            this._toolbars[L.EditToolbar.TYPE].on("enable", this._toolbarEnabled, this)),
          (L.toolbar = this));
      },
      onAdd: function (t2) {
        var e2,
          i2 = L.DomUtil.create("div", "leaflet-draw"),
          o2 = false;
        for (var a in this._toolbars)
          this._toolbars.hasOwnProperty(a) &&
            (e2 = this._toolbars[a].addToolbar(t2)) &&
            (o2 ||
              (L.DomUtil.hasClass(e2, "leaflet-draw-toolbar-top") ||
                L.DomUtil.addClass(e2.childNodes[0], "leaflet-draw-toolbar-top"),
              (o2 = true)),
            i2.appendChild(e2));
        return i2;
      },
    ...
    L.Map.mergeOptions({ drawControlTooltips: true, drawControl: false }),
    ...
    (L.Toolbar = L.Class.extend({
      initialize: function (t2) {
        ...
        1 === parseInt(e2[0], 10) && parseInt(e2[1], 10) >= 2
      ...
      addToolbar: function (t2) {
        var e2,
          i2 = L.DomUtil.create("div", "leaflet-draw-section"),
          o2 = 0,
          a = this._toolbarClass || "",
          n = this.getModeHandlers(t2);
        for (
          ...
          n[e2].enabled &&
            this._initModeHandler(n[e2].handler, this._toolbarContainer, o2++, a, n[e2].title);
        if (o2)
          return (
            (this._lastButtonIndex = --o2),
            (this._actionsContainer = L.DomUtil.create("ul", "leaflet-draw-actions")),
            i2.appendChild(this._toolbarContainer),
            i2.appendChild(this._actionsContainer),
            i2
          );
      },
      removeToolbar: function () {
        for (var t2 in this._modes)
          this._modes.hasOwnProperty(t2) &&
            (this._disposeButton(
              this._modes[t2].button,
              this._modes[t2].handler.enable,
              this._modes[t2].handler,
            ),
            this._modes[t2].handler.disable(),
            this._modes[t2].handler
        ...
        for (var e2 = 0, i2 = this._actionButtons.length; e2 < i2; e2++)
          this._disposeButton(
            this._actionButtons[e2].button,
            this._actionButtons[e2].callback,
            this,
          );
      ...
      _createButton: function (t2) {
        var e2 = L.DomUtil.create("a", t2.className || "", t2.container),
          i2 = L.DomUtil.create("span", "sr-only", t2.container);
        ((e2.href = "#"),
          e2.appendChild(i2),
          t2.title && ((e2.title = t2.title), (i2.innerHTML = t2.title)),
          t2.text && ((e2.innerHTML = t2.text), (i2.innerHTML = t2.text)));
        var o2 = this._detectIOS() ? "touchstart" : "click";
        return (
          L.DomEvent.on(e2, "click", L.DomEvent.stopPropagation)
            .on(e2, "mousedown", L.DomEvent.stopPropagation)
            .on(e2, "dblclick", L.DomEvent.stopPropagation)
            .on(e2, "touchstart", L.DomEvent.stopPropagation)
            .on(e2, "click", L.DomEvent.preventDefault)
            .on(e2, o2, t2.callback, t2.context),
          e2
        );
      },
      _disposeButton: function (t2, e2) {
        var i2 = this._detectIOS() ? "touchstart" : "click";
        L.DomEvent.off(t2, "click", L.DomEvent.stopPropagation)
          .off(t2, "mousedown", L.DomEvent.stopPropagation)
          .off(t2, "dblclick", L.DomEvent.stopPropagation)
          .off(t2, "touchstart", L.DomEvent.stopPropagation)
          .off(t2, "click", L.DomEvent.preventDefault)
          .off(t2, i2, e2);
      },
      _handlerActivated: function (t2) {
        (this.disable(),
          (this._activeMode = this._modes[t2.handler]),
      ...
      _showActionsToolbar: function () {
        var t2 = this._activeMode.buttonIndex,
          e2 = this._lastButtonIndex,
          i2 = this._activeMode.button.offsetTop - 1;
        (this._createActions(this._activeMode.handler),
          (this._actionsContainer.style.top = i2 + "px"),
          0 === t2 &&
    ...
    (L.Draw.Tooltip = L.Class.extend({
      initialize: function (t2) {
        ((this._map = t2),
          (this._popupPane = t2._panes.popupPane),
          (this._visible = false),
          (this._container = t2.options.drawControlTooltips
      ...
      updateContent: function (t2) {
        return this._container
          ? ((t2.subtext = t2.subtext || ""),
            0 !== t2.subtext.length || this._singleLineLabel
              ? t2.subtext.length > 0 &&
            ...
            (this._container.innerHTML =
              (t2.subtext.length > 0
                ? '<span class="leaflet-draw-tooltip-subtext">' + t2.subtext + "</span><br />"
                : "") +
              "<span>" +
              t2.text +
              "</span>"),
            t2.text || t2.subtext
              ? ((this._visible = true), (this._container.style.visibility = "inherit"))
              : ((this._visible = false), (this._container.style.visibility = "hidden")),
            this)
          : this;
      },
      updatePosition: function (t2) {
        var e2 = this._map.latLngToLayerPoint(t2),
          i2 = this._container;
        return (
          this._container &&
            (this._visible && (i2.style.visibility = "inherit"), L.DomUtil.setPosition(i2, e2)),
          this
        );
      },
    ...
    (L.DrawToolbar = L.Toolbar.extend({
      ...
      initialize: function (t2) {
        for (var e2 in this.options)
          this.options.hasOwnProperty(e2) &&
            t2[e2] &&
            (t2[e2] = L.extend({}, this.options[e2], t2[e2]));
      ...
      setOptions: function (t2) {
        ...
        for (var e2 in this._modes)
          this._modes.hasOwnProperty(e2) &&
            t2.hasOwnProperty(e2) &&
            this._modes[e2].handler.setOptions(t2[e2]);
      },
    })),
    (L.EditToolbar = L.Toolbar.extend({
      ...
      initialize: function (t2) {
        (t2.edit &&
          (void 0 === t2.edit.selectedPathOptions &&
            (t2.edit.selectedPathOptions = this.options.edit.selectedPathOptions),
          (t2.edit.selectedPathOptions = L.extend(
            {},
            this.options.edit.selectedPathOptions,
            t2.edit.selectedPathOptions,
          ))),
          t2.remove && (t2.remove = L.extend({}, this.options.remove, t2.remove)),
          t2.poly && (t2.poly = L.extend({}, this.options.poly, t2.poly)),
          (this._toolbarClass = "leaflet-draw-edit"),
          L.Toolbar.prototype.initialize.call(this, t2),
      ...
      getModeHandlers: function (t2) {
        ...
        return [
          ...
          },
          {
            ...
            handler: new L.EditToolbar.Delete(t2, { featureGroup: e2 }),
      ...
      _checkDisabled: function () {
        var t2,
          e2 = this.options.featureGroup,
          i2 = 0 !== e2.getLayers().length;
        (this.options.edit &&
          ((t2 = this._modes[L.EditToolbar.Edit.TYPE].button),
          i2
            ? L.DomUtil.removeClass(t2, "leaflet-disabled")
            : L.DomUtil.addClass(t2, "leaflet-disabled"),
          t2.setAttribute(
            "title",
            i2
          ...
          this.options.remove &&
            ((t2 = this._modes[L.EditToolbar.Delete.TYPE].button),
            i2
              ? L.DomUtil.removeClass(t2, "leaflet-disabled")
              : L.DomUtil.addClass(t2, "leaflet-disabled"),
            t2.setAttribute(
    ...
    (L.EditToolbar.Edit = L.Handler.extend({
      ...
      initialize: function (t2, e2) {
        if (
          (L.Handler.prototype.initialize.call(this, t2),
          L.setOptions(this, e2),
          (this._featureGroup = e2.featureGroup),
      ...
      _backupLayer: function (t2) {
        ...
        this._uneditedLayerProps[e2] ||
          (t2 instanceof L.Polyline || t2 instanceof L.Polygon || t2 instanceof L.Rectangle
            ? (this._uneditedLayerProps[e2] = {
                latlngs: L.LatLngUtil.cloneLatLngs(t2.getLatLngs()),
              })
            : t2 instanceof L.Circle
              ? (this._uneditedLayerProps[e2] = {
                  latlng: L.LatLngUtil.cloneLatLng(t2.getLatLng()),
                  radius: t2.getRadius(),
                })
              : (t2 instanceof L.Marker || t2 instanceof L.CircleMarker) &&
                (this._uneditedLayerProps[e2] = {
                  latlng: L.LatLngUtil.cloneLatLng(t2.getLatLng()),
                }));
      },
      ...
      _revertLayer: function (t2) {
        var e2 = L.Util.stamp(t2);
        ((t2.edited = false),
          this._uneditedLayerProps.hasOwnProperty(e2) &&
            (t2 instanceof L.Polyline || t2 instanceof L.Polygon || t2 instanceof L.Rectangle
              ? t2.setLatLngs(this._uneditedLayerProps[e2].latlngs)
              : t2 instanceof L.Circle
                ? (t2.setLatLng(this._uneditedLayerProps[e2].latlng),
                  t2.setRadius(this._uneditedLayerProps[e2].radius))
                : (t2 instanceof L.Marker || t2 instanceof L.CircleMarker) &&
                  t2.setLatLng(this._uneditedLayerProps[e2].latlng),
            t2.fire("revert-edited", { layer: t2 })));
      },
      _enableLayerEdit: function (t2) {
        var e2,
          i2,
          o2 = t2.layer || t2.target || t2;
        (this._backupLayer(o2),
          this.options.poly &&
            ((i2 = L.Util.extend({}, this.options.poly)), (o2.options.poly = i2)),
          this.options.selectedPathOptions &&
            ((e2 = L.Util.extend({}, this.options.selectedPathOptions)),
            e2.maintainColor &&
              ((e2.color = o2.options.color), (e2.fillColor = o2.options.fillColor)),
            (o2.options.original = L.extend({}, o2.options)),
            (o2.options.editing = e2)),
          o2 instanceof L.Marker
            ? (o2.editing && o2.editing.enable(),
              o2.dragging.enable(),
              o2
      ...
      _disableLayerEdit: function (t2) {
        ...
        ((e2.edited = false),
          e2.editing && e2.editing.disable(),
          delete e2.options.editing,
          delete e2.options.original,
          this._selectedPathOptions &&
            (e2 instanceof L.Marker
              ? this._toggleMarkerHighlight(e2)
              : (e2.setStyle(e2.options.previousOptions), delete e2.options.previousOptions)),
          e2 instanceof L.Marker
            ? (e2.dragging.disable(),
              e2
                .off("dragend", this._onMarkerDragEnd, this)
      ...
      _onTouchMove: function (t2) {
        var e2 = t2.originalEvent.changedTouches[0],
          i2 = this._map.mouseEventToLayerPoint(e2),
          o2 = this._map.layerPointToLatLng(i2);
    ...
    (L.EditToolbar.Delete = L.Handler.extend({
      ...
      _removeLayer: function (t2) {
        var e2 = t2.layer || t2.target || t2;
        (this._deletableLayers.removeLayer(e2),
          this._deletedLayers.addLayer(e2),
          e2.fire("deleted"));
      },
      _onMouseMove: function (t2) {
        this._tooltip.updatePosition(t2.latlng);
