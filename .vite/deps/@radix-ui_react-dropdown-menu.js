"use client";
import { Item, Root, createRovingFocusGroupScope } from "./chunk-BTQCLEWW.js";
import { Anchor, Arrow, Content, Root2, createPopperScope } from "./chunk-KH6CFC4X.js";
import { createCollection, useDirection } from "./chunk-DFWCBUVQ.js";
...
var Menu = (props) => {
  ...
  return (0, import_jsx_runtime2.jsx)(Root2, {
    ...
    children: (0, import_jsx_runtime2.jsx)(MenuProvider, {
      ...
      children: (0, import_jsx_runtime2.jsx)(MenuRootProvider, {
        scope: __scopeMenu,
...
var MenuAnchor = React2.forwardRef((props, forwardedRef) => {
...
var MenuContent = React2.forwardRef((props, forwardedRef) => {
    ...
    children: (0, import_jsx_runtime2.jsx)(Presence, {
      ...
      children: (0, import_jsx_runtime2.jsx)(Collection.Slot, {
        ...
        children: rootContext.modal
          ? (0, import_jsx_runtime2.jsx)(MenuRootContentModal, {
              ...contentProps,
              ref: forwardedRef,
            })
          : (0, import_jsx_runtime2.jsx)(MenuRootContentNonModal, {
              ...contentProps,
              ref: forwardedRef,
            }),
      }),
...
var MenuRootContentModal = React2.forwardRef((props, forwardedRef) => {
  const context = useMenuContext(CONTENT_NAME, props.__scopeMenu);
  ...
  return (0, import_jsx_runtime2.jsx)(MenuContentImpl, {
    ...props,
    ref: composedRefs,
...
var MenuContentImpl = React2.forwardRef((props, forwardedRef) => {
  const {
    __scopeMenu,
    loop = false,
    trapFocus,
  ...
  return (0, import_jsx_runtime2.jsx)(MenuContentProvider, {
    scope: __scopeMenu,
    searchRef,
    ...
    children: (0, import_jsx_runtime2.jsx)(ScrollLockWrapper, {
...
var MenuGroup = React2.forwardRef((props, forwardedRef) => {
...
var MenuLabel = React2.forwardRef((props, forwardedRef) => {
...
var MenuItem = React2.forwardRef((props, forwardedRef) => {
  ...
  return (0, import_jsx_runtime2.jsx)(MenuItemImpl, {
    ...itemProps,
    ref: composedRefs,
    disabled,
...
var MenuItemImpl = React2.forwardRef((props, forwardedRef) => {
  ...
  return (0, import_jsx_runtime2.jsx)(Collection.ItemSlot, {
    scope: __scopeMenu,
    disabled,
    textValue: textValue ?? textContent,
    children: (0, import_jsx_runtime2.jsx)(Item, {
      asChild: true,
      ...rovingFocusGroupScope,
      focusable: !disabled,
...
var MenuCheckboxItem = React2.forwardRef((props, forwardedRef) => {
  const { checked = false, onCheckedChange, ...checkboxItemProps } = props;
  return (0, import_jsx_runtime2.jsx)(ItemIndicatorProvider, {
    scope: props.__scopeMenu,
    checked,
...
var MenuRadioGroup = React2.forwardRef((props, forwardedRef) => {
  const { value, onValueChange, ...groupProps } = props;
  const handleValueChange = useCallbackRef(onValueChange);
  return (0, import_jsx_runtime2.jsx)(RadioGroupProvider, {
    scope: props.__scopeMenu,
    value,
    onValueChange: handleValueChange,
    children: (0, import_jsx_runtime2.jsx)(MenuGroup, { ...groupProps, ref: forwardedRef }),
  });
});
MenuRadioGroup.displayName = RADIO_GROUP_NAME;
var RADIO_ITEM_NAME = "MenuRadioItem";
var MenuRadioItem = React2.forwardRef((props, forwardedRef) => {
...
var MenuItemIndicator = React2.forwardRef((props, forwardedRef) => {
  ...
  return (0, import_jsx_runtime2.jsx)(Presence, {
    ...
    children: (0, import_jsx_runtime2.jsx)(Primitive.span, {
      ...itemIndicatorProps,
      ref: forwardedRef,
...
var MenuSeparator = React2.forwardRef((props, forwardedRef) => {
...
var MenuArrow = React2.forwardRef((props, forwardedRef) => {
...
var MenuSub = (props) => {
  ...
  return (0, import_jsx_runtime2.jsx)(Root2, {
    ...
    children: (0, import_jsx_runtime2.jsx)(MenuProvider, {
      ...
      content,
      onContentChange: setContent,
      children: (0, import_jsx_runtime2.jsx)(MenuSubProvider, {
        scope: __scopeMenu,
        contentId: useId(),
        triggerId: useId(),
        trigger,
...
var MenuSubTrigger = React2.forwardRef((props, forwardedRef) => {
  ...
  return (0, import_jsx_runtime2.jsx)(MenuAnchor, {
    asChild: true,
    ...scope,
    children: (0, import_jsx_runtime2.jsx)(MenuItemImpl, {
...
var MenuSubContent = React2.forwardRef((props, forwardedRef) => {
  const portalContext = usePortalContext(CONTENT_NAME, props.__scopeMenu);
  ...
  return (0, import_jsx_runtime2.jsx)(Collection.Provider, {
    ...
    children: (0, import_jsx_runtime2.jsx)(Presence, {
      ...
      children: (0, import_jsx_runtime2.jsx)(Collection.Slot, {
        scope: props.__scopeMenu,
        children: (0, import_jsx_runtime2.jsx)(MenuContentImpl, {
...
var DropdownMenu = (props) => {
  ...
  return (0, import_jsx_runtime3.jsx)(DropdownMenuProvider, {
    ...
    modal,
    children: (0, import_jsx_runtime3.jsx)(Root3, {
      ...menuScope,
      open,
      onOpenChange: setOpen,
      dir,
...
var DropdownMenuTrigger = React3.forwardRef((props, forwardedRef) => {
  const { __scopeDropdownMenu, disabled = false, ...triggerProps } = props;
  const context = useDropdownMenuContext(TRIGGER_NAME, __scopeDropdownMenu);
  const menuScope = useMenuScope(__scopeDropdownMenu);
  return (0, import_jsx_runtime3.jsx)(Anchor2, {
    asChild: true,
    ...menuScope,
...
var DropdownMenuContent = React3.forwardRef((props, forwardedRef) => {
  ...
  return (0, import_jsx_runtime3.jsx)(Content2, {
...
var DropdownMenuGroup = React3.forwardRef((props, forwardedRef) => {
...
var DropdownMenuLabel = React3.forwardRef((props, forwardedRef) => {
...
var DropdownMenuItem = React3.forwardRef((props, forwardedRef) => {
...
var DropdownMenuCheckboxItem = React3.forwardRef((props, forwardedRef) => {
  ...
  const menuScope = useMenuScope(__scopeDropdownMenu);
  return (0, import_jsx_runtime3.jsx)(CheckboxItem, {
    ...menuScope,
    ...checkboxItemProps,
    ref: forwardedRef,
  });
...
var DropdownMenuRadioGroup = React3.forwardRef((props, forwardedRef) => {
  ...
  const menuScope = useMenuScope(__scopeDropdownMenu);
  return (0, import_jsx_runtime3.jsx)(RadioGroup, {
    ...menuScope,
    ...radioGroupProps,
    ref: forwardedRef,
  });
...
var DropdownMenuRadioItem = React3.forwardRef((props, forwardedRef) => {
  ...
  const menuScope = useMenuScope(__scopeDropdownMenu);
  return (0, import_jsx_runtime3.jsx)(RadioItem, {
    ...menuScope,
    ...radioItemProps,
    ref: forwardedRef,
  });
...
var DropdownMenuItemIndicator = React3.forwardRef((props, forwardedRef) => {
  ...
  const menuScope = useMenuScope(__scopeDropdownMenu);
  return (0, import_jsx_runtime3.jsx)(ItemIndicator, {
    ...menuScope,
    ...itemIndicatorProps,
    ref: forwardedRef,
  });
...
var DropdownMenuSeparator = React3.forwardRef((props, forwardedRef) => {
  ...
  const menuScope = useMenuScope(__scopeDropdownMenu);
  return (0, import_jsx_runtime3.jsx)(Separator, {
    ...menuScope,
    ...separatorProps,
    ref: forwardedRef,
  });
...
var DropdownMenuArrow = React3.forwardRef((props, forwardedRef) => {
...
var DropdownMenuSubTrigger = React3.forwardRef((props, forwardedRef) => {
  ...
  const menuScope = useMenuScope(__scopeDropdownMenu);
  return (0, import_jsx_runtime3.jsx)(SubTrigger, {
    ...menuScope,
    ...subTriggerProps,
    ref: forwardedRef,
  });
...
var DropdownMenuSubContent = React3.forwardRef((props, forwardedRef) => {
  ...
  const menuScope = useMenuScope(__scopeDropdownMenu);
  return (0, import_jsx_runtime3.jsx)(SubContent, {
    ...menuScope,
    ...subContentProps,
    ref: forwardedRef,
    style: {
