...
var vt = (r, s, e) =>
  s in r
    ? Bt(r, s, { enumerable: true, configurable: true, writable: true, value: e })
    : (r[s] = e);
var St = (r, s) => {
...
function Tt({ containerRef: r, inputRef: s, pushPasswordManagerStrategy: e, isFocused: u }) {
  let [P, D] = S.useState(false),
    [G, H] = S.useState(false),
    [F, W] = S.useState(false),
    Z = S.useMemo(
      () =>
        e === "none"
          ? false
          : (e === "increase-width" || e === "experimental-no-flickering") && P && G,
      [P, G, e],
    ),
    T = S.useCallback(() => {
      let f = r.current,
      ...
      let a = f,
        ...
        z = B - Ot,
        q = A;
      (document.querySelectorAll(xt).length === 0 && document.elementFromPoint(z, q) === f) ||
        (D(true), W(true));
    }, [r, s, F, e]);
  return (
    S.useEffect(() => {
    ...
    { hasPWMBadge: P, willPushPWMBadge: Z, PWM_BADGE_SPACE_WIDTH: Gt }
  );
}
...
var Lt = n.forwardRef((A, B) => {
  ...
  let [q, nt] = n.useState(typeof a.defaultValue == "string" ? a.defaultValue : ""),
    ...
    J = n.useRef({
      ...
      isIOS:
        ...
        ((lt = (X = window == null ? void 0 : window.CSS) == null ? void 0 : X.supports) == null
          ? void 0
  ...
  (n.useImperativeHandle(B, () => l.current, []),
    n.useEffect(() => {
      let t = l.current,
        o = K.current;
      if (!t || !o) return;
      (J.current.value !== t.value && J.current.onChange(t.value),
        (V.current.prev = [t.selectionStart, t.selectionEnd, t.selectionDirection]));
      function d() {
      ...
      if (
        (document.addEventListener("selectionchange", d, { capture: true }),
        d(),
        document.activeElement === t && Q(true),
        ...
        if (((c.id = "input-otp-style"), document.head.appendChild(c), c.sheet)) {
          ...
          ($(
            ...
            $(c.sheet, `[data-input-otp]:-webkit-autofill { ${b} }`),
            $(
              c.sheet,
              "@supports (-webkit-touch-callout: none) { [data-input-otp] { letter-spacing: -.6em !important; font-weight: 100 !important; font-stretch: ultra-condensed; font-optical-sizing: none !important; left: -1px !important; right: 1px !important; } }",
            ),
            $(c.sheet, "[data-input-otp] + * { pointer-events: all !important; }"));
        }
      }
      let R = () => {
  ...
  let [ot, rt] = n.useState(false),
    [j, Q] = n.useState(false),
    [M, L] = n.useState(null),
    [k, N] = n.useState(null);
  (n.useEffect(() => {
    ht(() => {
      ...
      let t = (p = l.current) == null ? void 0 : p.selectionStart,
  ...
  let O = Tt({ containerRef: K, inputRef: l, pushPasswordManagerStrategy: F, isFocused: j }),
    st = n.useCallback(
      (t) => {
    ...
    ct = n.useCallback(
      (t) => {
        ...
        let d = t.clipboardData.getData("text/plain"),
          R = W ? W(d) : d;
        t.preventDefault();
        let p = (g = l.current) == null ? void 0 : g.selectionStart,
          c = (E = l.current) == null ? void 0 : E.selectionEnd,
          v = (p !== c ? i.slice(0, p) + R + i.slice(c) : i.slice(0, p) + R + i.slice(p)).slice(
            0,
            e,
          );
    ...
    Mt = n.useMemo(
      () =>
        n.createElement(
          "input",
          bt(St({ autoComplete: a.autoComplete || "one-time-code" }, a), {
            "data-input-otp": true,
      ...
      () => ({
        slots: Array.from({ length: e }).map((t, o) => {
          ...
          let d = j && M !== null && k !== null && ((M === k && o === M) || (o >= M && o < k)),
            R = i[o] !== void 0 ? i[o] : null,
            p = i[0] !== void 0 ? null : (c = D == null ? void 0 : D[o]) != null ? c : null;
    ...
    Ct = n.useMemo(() => (f ? f(tt) : n.createElement(jt.Provider, { value: tt }, h)), [h, tt, f]);
  return n.createElement(
    n.Fragment,
    null,
    T !== null && n.createElement("noscript", null, n.createElement("style", null, T)),
    n.createElement(
      "div",
      { ref: K, "data-input-otp-container": true, style: It, className: Z },
      Ct,
      n.createElement(
        "div",
